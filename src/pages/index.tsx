...
  const labelClass =
    "text-lg sm:text-xl lg:text-3xl font-semibold text-black";
  const buttonClass =
    "text-sm sm:text-base bg-gray-100 text-gray-800 rounded-full px-6 py-3 hover:bg-gray-300 transition";
...
            <p
              className={
                "text-lg sm:text-xl lg:text-3xl font-semibold text-white"
              }
            >
              Core Value
            </p>
...
              <button className="text-sm sm:text-base bg-white/20 text-white rounded-full px-6 py-3 hover:bg-white/40 transition backdrop-blur-sm">
...
              viewport={{ once: true, amount: 0.3 }}
            >
              <h2 className="text-xl md:text-3xl lg:text-5xl font-bold mb-4 md:mb-7 tracking-wide text-white">
                {content.section2.title}
              </h2>
              <p className="text-sm md:text-base lg:text-xl text-white/80 leading-relaxed whitespace-pre-line tracking-wide">
...
                <motion.div
                  key={idx}
                  className="w-32 h-32 lg:w-40 lg:h-40 xl:w-44 xl:h-44 rounded-full bg-white/10 border border-white/10 flex flex-col justify-center items-center text-sm md:text-base text-white backdrop-blur-sm hover:bg-white/20 transition"
...
                  viewport={{ once: true, amount: 0.3 }}
                >
                  <p className="font-bold text-base md:text-lg lg:text-2xl tracking-wide">
                    {title}
                  </p>
...
            viewport={{ once: true, amount: 0.3 }}
          >
            <h2 className="text-2xl md:text-4xl lg:text-6xl font-bold mb-0 md:mb-3 tracking-wide text-black">
              {content.section3.title}
            </h2>
            <p className=" text-2xl md:text-4xl lg:text-6xl font-bold tracking-wide">
...
                <motion.div
                  key={index}
                  className="relative w-full h-[250px] md:h-[350px] lg:h-[550px] overflow-hidden rounded-xl shadow-md hover:scale-105 transition-transform duration-300 ease-out"
...
                  <div className="absolute bottom-0 lg:bottom-3 z-20 w-full px-4 sm:px-5 lg:px-6 py-4 sm:py-5 text-white text-xs sm:text-sm md:text-base lg:text-xl tracking-wide leading-tight sm:leading-snug">
                    <p className="text-sm md:text-base lg:text-xl mb-1 md:mb-2 lg:mb-7 ">
                      {card.subtitle}
                    </p>
                    <h3 className="text-lg md:text-xl lg:text-3xl font-bold mb-1 md:mb-1 lg:mb-2">
                      {card.title}
                    </h3>
...
          <motion.div
            className="text-left text-black mb-10 max-w-7xl mx-[30px] md:mx-[120px] text-lg sm:text-xl lg:text-3xl font-semibold tracking-wide"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.3 }}
...
            <h2 className="text-2xl md:text-4xl lg:text-6xl font-bold tracking-wide text-black leading-normal mt-5 mb-5">
              고객 맞춤형 장비/제조 서비스를 제공합니다
            </h2>

            <p className="text-base md:text-lg lg:text-2xl text-black/80 font-medium leading-relaxed mb-8">
...
              <motion.div
                className="relative w-48 h-48 lg:w-64 lg:h-64 xl:w-72 xl:h-72 aspect-square rounded-full flex flex-col justify-end items-center text-center text-white p-5 shadow-xl hover:shadow-2xl transition-shadow duration-300 cursor-default mb-8 lg:mb-0 overflow-hidden"
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true, amount: 0.3 }}
...
                <h3 className="sm:text-lg md:text-xl lg:text-3xl font-semibold pb-5 z-20">
                  솔루션 서비스
                </h3>
              </motion.div>

              <motion.div
                className="relative w-48 h-48 lg:w-64 lg:h-64 xl:w-72 xl:h-72 rounded-full flex flex-col justify-end items-center text-center text-white p-5 shadow-xl hover:shadow-2xl transition-shadow duration-300 cursor-default mb-8 lg:mb-0 overflow-hidden"
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true, amount: 0.3 }}
                variants={circleVariants}
...
              <motion.div
                className="relative w-48 h-48 lg:w-64 lg:h-64 xl:w-72 xl:h-72 rounded-full flex flex-col justify-end items-center text-center text-white p-5 shadow-xl hover:shadow-2xl transition-shadow duration-300 cursor-default overflow-hidden"
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true, amount: 0.3 }}
                variants={circleVariants}

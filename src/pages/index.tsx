      ...
      <main>
        ...
        <section className="flex items-center justify-center w-full h-screen text-center bg-white p-4">
          <div className="flex flex-col items-center justify-center space-y-4 px-4">
            ...
            <p className="text-base md:text-lg text-gray-600 max-w-xl leading-relaxed whitespace-pre-line">
            ...
            <div className="absolute inset-0 flex flex-col justify-center text-white z-10 px-4 md:pl-12 text-center md:text-left items-start">
              ...
              >
                <Link href="/company/vision">
                  <button className="bg-white text-black text-sm md:text-base font-medium px-6 py-3 rounded-full hover:bg-gray-200 transition-colors">
              ...
              <div className="flex-1 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 lg:gap-0 relative w-full lg:h-full">
                ...
                <motion.div
                  className=" relative w-44 h-44 lg:w-64 lg:h-64 rounded-full flex flex-col justify-end items-center text-center text-white p-5 shadow-xl hover:shadow-2xl transition-shadow duration-300 cursor-default
                   mb-8 lg:mb-0
                   lg:absolute lg:right-40 lg:-translate-x-1/2 lg:bottom-120 lg:transform-none
                   overflow-hidden"
                  initial="hidden"
                  whileInView="visible"
                  viewport={{ once: true, amount: 0.3 }}
                ...
                <motion.div
                  className="relative w-44 h-44 lg:w-64 lg:h-64 rounded-full flex flex-col justify-end items-center text-center text-white p-5 shadow-xl hover:shadow-2xl transition-shadow duration-300 cursor-default
                   lg:absolute lg:left-100 lg:bottom-140 bottom-5 lg:transform-none
                   overflow-hidden"
                  initial="hidden"
                  whileInView="visible"
                  viewport={{ once: true, amount: 0.3 }}

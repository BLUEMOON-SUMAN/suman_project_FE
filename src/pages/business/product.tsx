...
export default function ProductPage() {
  const [showAllEquipment, setShowAllEquipment] = useState(false); // (kept if you need later)
  ...
  return (
    <>
      ...
      <Layout>
        {/* ===== Match rnd.tsx: use main wrapper + paddingTop for fixed header ===== */}
        <main className="min-h-screen bg-white text-slate-900" style={{ paddingTop: "90px" }}>
          {/* Hero: same layout style as rnd.tsx (you can add a subtitle if desired) */}
          <HeroSection
            title={lang === "KOR" ? "제품 소개" : "Product"}
            backgroundImage="/images/sub_banner/business_hero.png"
          />

          {/* Breadcrumb placed directly under hero (same as rnd.tsx) */}
          <BreadcrumbSection

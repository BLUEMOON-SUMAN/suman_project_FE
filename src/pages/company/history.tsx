...
export default function HistoryPage() {
  ...
  useEffect(() => {
    document.title = lang === "KOR" ? "연혁" : "History";
  }, [lang]);
  ...
  return (
    <>
      ...
      <Layout>
        {/* Match rnd.tsx structure: big hero + breadcrumb inside a main with top padding */}
        <main className="min-h-screen bg-white text-slate-900" style={{ paddingTop: "90px" }}>
          <HeroSection
            title={content.title}
            subtitle={lang === "KOR" ? "회사 연혁" : "Company History"}
          ...
          <section className="relative w-full min-h-[520px] md:min_h-[620px] md:min-h-[620px]">
            ...
            >
              ...
              <svg
                ...
                style={{
                  transform: "translateY(calc(var(--arrow-shift-down) - var(--arrow-shift-up)))",
                  ...arrowShiftStyle,
                }}
              >
                <defs>

export const ceoText = {
    KOR: {//
        intro: "안녕하십니까.",
        body: `(주)수만 기업은 정밀 가공 기술을 기반으로 자동차, 전기전자,
이차전지 산업에 필요한 부품과 모듈, 장비를 설계, 제조하는 전문 기업입니다.
저희는 끊임없는 기술 혁신과 철저한 품질 관리를 통해 고객이 신뢰할 수 있는
제품을 공급해왔으며, 산업의 변화 속에서도 유연하고 정직한 기술력으로

      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="fixed top-0 right-0 w-full sm:w-[50%] md:w-[30%] lg:w-[20%] min-h-screen bg-white text-black px-4 py-4 space-y-2 shadow-lg z-50 flex flex-col justify-start"
